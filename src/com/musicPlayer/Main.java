...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        album.addSong("Vengeance",4.5);
        album.addSong("life in rio",3.5);
        ...
        albums.get(0).addToPlayList("Vengeance",playList_1);
        albums.get(0).addToPlayList("life in rio",playList_1);
